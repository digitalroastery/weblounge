...
public class FileContentImplXmlTest extends FileContentImplTest {
  ...
  /**
   * Test method for {@link ch.entwine.weblounge.common.impl.content.ResourceContentImpl#toXml()}.
   */
  @Test
  public void testToXml() {
    String testXml = TestUtils.loadXmlFromResource(testFile);
    try {
      assertEquals(testXml, new String(content.toXml().getBytes("utf-8"), "utf-8"));
