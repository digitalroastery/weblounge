...
import ch.o2it.weblounge.cache.impl.filter.NullFilter;
...
public class CacheTransactionTest {
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#getHandle()}.
   */
  @Test
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#getOutputStream()}.
   */
  @Test
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#getContent()}.
   */
  @Test
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#getHeaders()}.
   */
  @Test
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#getTags()}.
   */
  @Test
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#getFilter()}.
   */
  @Test
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#invalidate()}.
   */
  @Test
  ...
  /**
   * Test method for {@link ch.o2it.weblounge.cache.impl.CacheTransaction#isValid()}.
   */
  @Test
