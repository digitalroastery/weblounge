...
public class TaggedCacheHandleTest {
  ...
  /**
   * Test method for
   * {@link ch.o2it.weblounge.cache.impl.handle.TaggedCacheHandle#testGetPrimaryTags()}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link ch.o2it.weblounge.cache.impl.handle.TaggedCacheHandle#createKey(ch.o2it.weblounge.common.request.CacheTag[])}
   * .
   */
  @Test
