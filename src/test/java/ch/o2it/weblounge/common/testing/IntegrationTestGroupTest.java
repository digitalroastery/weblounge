...
public class IntegrationTestGroupTest {
  ...
  /**
   * Test method for
   * {@link ch.o2it.weblounge.common.impl.testing.IntegrationTestGroup#execute(java.lang.String)}
   * .
   * 
   * @throws Exception
   */
  ...
  public void testExecute() throws Exception {
    ...
    for (int i = 0; i < 3; i++) {
      IntegrationTestCase testCase = new IntegrationTestCase("test", "/test", null) {
         ...
         * {@inheritDoc}
         * 
         * @see ch.o2it.weblounge.common.impl.testing.IntegrationTestCase#execute(java.lang.String)
         */
        @Override
