...
public abstract class AbstractJSONAction extends AbstractAjaxAction {
  ...
  /**
   * @see ch.o2it.weblounge.site.impl.site.impl.AbstractAjaxAction.module.action.AbstractAjaxActionHandler#startAjaxResponse(ch.o2it.weblounge.api.request.WebloungeRequest,
