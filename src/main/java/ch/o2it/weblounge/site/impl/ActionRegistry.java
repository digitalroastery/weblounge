...
/**
 * This registry keeps track of action bundles defined for a given site and module
 * and provides them through its <code>get</code> method.
 * 
...
public class ActionRegistry extends Registry {
	...
	/**
	 * Returns the action handler bundle that has been registered for the given url
	 * or <code>null</code> if no such registration exists.
	 * 
	 * @param url the url
	 * @param the rendering method
	 * @return the bundle
	 */
	 ...
	 * 
	 * @param url the url
	 * @param exactMatch <code>true</code> to only return exact matches
	 * @param the rendering method
	 * @return the bundle
	 */
	 ...
	 * 
	 * @param url the url
	 * @param exactMatch <code>true</code> to give an exact match
	 ...
	 */
	public ActionBundleConfiguration getActionHandlerBundleConfigurationl(String id) {
	 ...
	 * @param o the action bundle
	 * @see ch.o2it.weblounge.core.util.registry.Registry#put(java.lang.Object, java.lang.Object)
	 */
