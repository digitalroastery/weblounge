 ...
 */
public final class ActionConfigurationImpl extends OptionsSupport implements ActionConfiguration {
   ...
   * possible output format of an action. The methods usually include
  ...
  /**
   * Reads the action handler configuration from the given xml configuration
   * node.
   * 
   * @param config
   *          the handler configuration node
   * @param path
   ...
   * 
   * @param config
   *          action configuration node
   * @param path
   *          the XPath object used to parse the configuration
   */
  private void readHandler(XPath path, Node config)
   ...
   *          the XPath object used to parse the configuration
   */
  private void readScripts(XPath path, Node config)
      throws ConfigurationException {
