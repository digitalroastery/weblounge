...
/**
 * The action bundle configuration stores configuration information about an
 * action handler bundle. The configuration data is being read from the
...
public final class ActionBundleConfiguration extends SecuredObject implements Localizable {
  ...
  /**
   * Reads the action bundle configuration from the given xml configuration
   * node.
   * 
   * @param config
