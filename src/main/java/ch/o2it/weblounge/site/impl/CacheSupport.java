...
public class CacheSupport {
  ...
  /**
   * Removes the given url from the cache. All values except <code>url</code>
  ...
  /**
   * Removes the given url from the cache. All values except <code>url</code>
   * may be <code>null</code>. The more parameters you specify, the less pages
  ...
  /**
   * Removes the given action from the cache. All values except
   * <code>action</code> may be <code>null</code>. The more parameters you
   * specify, the less pages will be removed from cache.
   * 
   * @param action
   *          the action to remove
   * @param language
   ...
   */
  public static void invalidateAction(Module module, String action,
      Language language, User user, Map<String, String> params) {
    CacheServiceImpl cache = (CacheServiceImpl) SystemServices.getEnabled(CacheServiceImpl.ID);
    if (cache == null)
      return;
