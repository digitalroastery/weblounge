...
/**
 * The http service tracker watches osgi web server instances come and go and
 * registers and unregisters the weblounge dispatcher with the first to come.
 */
public class HttpServiceTracker extends ServiceTracker {
   ...
   *          the dispatcher
   */
  HttpServiceTracker(BundleContext context, WebloungeDispatcherServlet dispatcher) {
  ...
  public Object addingService(ServiceReference reference) {
    ...
    try {
      ...
      log_.error("Namespace error registering weblounge dispatcher with http service " + httpService + ": " + e.getMessage());
      httpService = null;
    }
    return null;
  }
  ...
  public void removedService(ServiceReference reference, Object service) {
    log_.info("Weblounge dispatcher disconnected from http service " + reference.getBundle().getSymbolicName());
