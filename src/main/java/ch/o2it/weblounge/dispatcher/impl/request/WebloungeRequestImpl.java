...
/**
 * This class is a wrapper to the <code>HttpServletRequest</code> with 
 * weblounge specific functionality enhancements, e. g. to get access to the
 * requested site or language.
 * 
...
//			AuthenticationService service = (AuthenticationService)getSite().getService(AuthenticationService.ID, true);
//			if (service != null && service.isEnabled()) {
//				user = service.login(ctxt);
//				if (user != null) {
//					SessionAttributes attribs = (SessionAttributes)getSession().getAttribute(SessionAttributes.ID);
...
//		}
	...
	/**
	 * Returns <code>true</code> if <code>o</code> represents the same
	 * request object.
	 * 
