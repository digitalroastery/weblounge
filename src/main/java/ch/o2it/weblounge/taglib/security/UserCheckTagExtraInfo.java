...
/**
 * This class provides runtime information about the <code>UserCheckTag</code>
 * jsp tag.
 */
public class UserCheckTagExtraInfo extends TagExtraInfo {
  ...
  public VariableInfo[] getVariableInfo(TagData tagData) {
    return new VariableInfo[] { new VariableInfo(UserCheckTagVariables.USER, User.class.getName(), true, VariableInfo.NESTED), };
  }
