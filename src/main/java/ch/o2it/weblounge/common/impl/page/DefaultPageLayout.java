...
public class DefaultPageLayout extends LocalizableObject implements PageLayout {
   ...
   * @see ch.o2it.weblounge.PageLayout.content.Layout#getIdentifier()
   */
   ...
   * @see ch.o2it.weblounge.common.page.PageLayout#isEditable(java.lang.String,
   ...
   *          the user
   * 
   * @see ch.o2it.weblounge.common.page.PageLayout#isMovable(java.lang.String,
   *      int, ch.o2it.weblounge.common.user.User)
   */
   ...
   * @param user
   *          the user
   * @see ch.o2it.weblounge.common.page.PageLayout#isRemovable(java.lang.String,
   *      int, ch.o2it.weblounge.common.user.User)
   */
