...
public abstract class IntegrationTestBase implements IntegrationTest {
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.testing.kernel.IntegrationTest#getName()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.testing.IntegrationTest#getGroup()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.testing.IntegrationTest#getExecutionOrder()
   */
