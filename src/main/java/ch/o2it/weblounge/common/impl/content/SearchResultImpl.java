...
public class SearchResultImpl extends LocalizableObject implements SearchResult {
   ...
   * 
   * @see ch.o2it.weblounge.common.content.api.content.SearchResult#getTitle()
   */
  ...
  /**
   * @see ch.o2it.weblounge.common.content.api.content.SearchResult#getUrl()
   */
  ...
  /**
   * @see ch.o2it.weblounge.common.content.api.content.SearchResult#getPreview()
   */
  ...
  /**
   * @see ch.o2it.weblounge.common.content.api.content.SearchResult#getPreviewRenderer()
   */
  ...
  /**
   * @see ch.o2it.weblounge.common.content.api.content.SearchResult#getRelevance()
   */
   ...
   * 
   * @see ch.o2it.weblounge.common.content.api.content.SearchResult#getSource()
   */
