...
public class LinkImpl implements Link {
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#setCharset(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#getCharset()
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#setMedia(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#getMedia()
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#setRelation(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#getRelation()
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#setReverseRelation(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#getReverseRelation()
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#setType(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.page.Link#getType()
   */
