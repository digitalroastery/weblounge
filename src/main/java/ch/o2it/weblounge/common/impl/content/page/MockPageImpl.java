...
public class MockPageImpl implements Page {
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#getURI()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#setType(java.lang.String)
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#getType()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#isLocked()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#getLockOwner()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#getSubjects()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#getTitle()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#getTitle(ch.o2it.weblounge.common.language.Language)
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#setTitle(java.lang.String,
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.content.Resource#toXml()
   */
  public String toXml() {
    throw new UnsupportedOperationException("Not implemented in mock page");
  }
