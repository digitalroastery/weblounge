...
/**
 * This support implementation provides special methods for encoding <code>Ajax</code> responses.
 * 
...
public abstract class AbstractAjaxAction extends ActionSupport {
	 ...
	 */
	public abstract void startAjaxResponse(WebloungeRequest request, WebloungeResponse response);
	 ...
	 * response. The call serves the single purpose acquire resources and set up for
	 * the call to <code>startPage</code>.
	 * 
	 * @param request the weblounge request
	 * @param response the weblounge response
	 * @param method the output method
	 * @see ch.o2it.weblounge.common.site.Action.module.ActionHandler#configure(WebloungeRequest, WebloungeResponse, String)
	 */
	public final void configure(WebloungeRequest request, WebloungeResponse response, String method) {
	 ...
	 * @see ch.o2it.weblounge.common.site.Action.module.ActionHandler#startPage(ch.o2it.weblounge.api.request.WebloungeRequest, ch.o2it.weblounge.api.request.WebloungeResponse)
	 */
	 ...
	 *                own or have the template do the rendering.
	 * @see ch.o2it.weblounge.common.site.Action.module.ActionHandler#startComposer(ch.o2it.weblounge.api.request.WebloungeRequest, ch.o2it.weblounge.api.request.WebloungeResponse, java.lang.String)
	 */
	 ...
	 *                own or have the template do the rendering.
	 * @see ch.o2it.weblounge.common.site.Action.module.ActionHandler#startPagelet(ch.o2it.weblounge.api.request.WebloungeRequest, ch.o2it.weblounge.api.request.WebloungeResponse, java.lang.String, int)
	 */
	public final int startPagelet(
			WebloungeRequest request,
			WebloungeResponse response,
			String composer,
	 ...
	 * @param id the ajax id
	 * @param body the ajax response body
	 * @throws IOException if writing to the response failed
	 */
	protected void sendAjaxElement(WebloungeRequest request, WebloungeResponse response, String id, String body) throws IOException {
		sendAjaxResponse(request, response, "element", id, body);
	}

	/**
	 * Sends back an ajax - compatible object response, which will look similar
	 * to this one:
	 * 
	 * <pre>
	 * &lt;ajax-response&gt; 
	 ...
	 * @throws IOException if writing to the response failed
	 */
	protected void sendAjaxObject(WebloungeRequest request, WebloungeResponse response, String id, String body) throws IOException {
	 ...
	 * @param request the request
	 * @param response the response
	 * @param uri the ajax id
	 * @param body the ajax response body
	 * @throws IOException if writing to the response failed
	 */
	protected void sendAjaxResponse(WebloungeRequest request, WebloungeResponse response, List<AjaxResponsePart> parts) throws IOException {
	 ...
	 * @param request the request
	 * @param response the response
	 * @param type the response type, either "element" or "object"
	 * @param id the ajax id
	 * @param body the ajax response body
	 * @throws IOException if writing to the response failed
	 */
	private void sendAjaxResponse(WebloungeRequest request, WebloungeResponse response, String type, String id, String body) throws IOException {
		StringBuilder s = new StringBuilder();
		s.append("<ajax-response>");
	...
	/**
	 * Sends back a JSON - compatible object response, which will look similar
	 * to this one:
	 * 
	 * <pre>
	 * {
