 ...
 * <p>
 * Since it is possible that additional modules are added or removed while the system
 * is up and running, the module manager keeps watching the <code>modules</code>
...
public final class ModuleManager {
	 ...
	 * 
	 * @param site the site that is shut down
	 */
	public void destroy() {
		// Nothing to do
	}
	...
	/**
	 * Configures the module that is associated with the given module configuration.
	 * 
	 * @param config the module configuration
	 */
	Module configureModule(ModuleConfigurationImpl config) throws ConfigurationException {
	 ...
	 * 
	 * @param module the module to restart
	 */
