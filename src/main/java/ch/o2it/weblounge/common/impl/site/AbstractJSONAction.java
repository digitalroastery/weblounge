...
public abstract class AbstractJSONAction extends AbstractAjaxAction {
   ...
   */
  public abstract void startJSONResponse(WebloungeRequest request,
      WebloungeResponse response);

  /**
   * @see ch.o2it.weblounge.common.impl.site.site.impl.AbstractAjaxAction.module.action.AbstractAjaxActionHandler#startAjaxResponse(ch.o2it.weblounge.api.request.WebloungeRequest,
   *      ch.o2it.weblounge.api.request.WebloungeResponse)
   */
  public final void startAjaxResponse(WebloungeRequest request,
      WebloungeResponse response) {
