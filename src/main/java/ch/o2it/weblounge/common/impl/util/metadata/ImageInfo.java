 ...
 *   return;
 * }
 * System.out.println(ii.getFormatName() + &quot;, &quot; + ii.getMimeType() + &quot;, &quot; + ii.getWidth() + &quot; x &quot; + ii.getHeight() + &quot; pixels, &quot; + ii.getBitsPerPixel() + &quot; bits per pixel, &quot; + ii.getNumberOfImages() + &quot; image(s), &quot; + ii.getNumberOfComments() + &quot; comment(s).&quot;);
...
public class ImageInfo {
   ...
   * the JPEG stream is progressive (see {@link #isProgressive()}).
   */
   ...
   * whether the PNG stream is interlaced (see {@link #isProgressive()}).
   */
   ...
   */
  private static final String[] MIME_TYPE_STRINGS = { "image/jpeg", "image/gif", "image/png", "image/bmp", "image/pcx", "image/iff", "image/ras", "image/x-portable-bitmap", "image/x-portable-graymap", "image/x-portable-pixmap", "image/psd", "application/x-shockwave-flash" };
   ...
   *           if index is smaller than 0 or larger than or equal to the number
   *           of comments retrieved
   ...
   * <code>setDetermineImageNumber(true);</code> was called before a successful
   * call to {@link #check()}. This value can currently be only different from
