...
public abstract class ActionHandlerSupport extends AbstractActionHandler {
	 ...
	 * @see ch.o2it.weblounge.Action.module.ActionHandler#configure(WebloungeRequest, WebloungeResponse, String)
	 */
	 ...
	 * @see ch.o2it.weblounge.Action.module.ActionHandler#startPage(ch.o2it.weblounge.api.request.WebloungeRequest, ch.o2it.weblounge.api.request.WebloungeResponse)
	 */
	 ...
	 *                own or have the template do the rendering.
	 * @see ch.o2it.weblounge.Action.module.ActionHandler#startComposer(ch.o2it.weblounge.api.request.WebloungeRequest, ch.o2it.weblounge.api.request.WebloungeResponse, java.lang.String)
	 */
	 ...
	 *                own or have the template do the rendering.
	 * @see ch.o2it.weblounge.Action.module.ActionHandler#startPagelet(ch.o2it.weblounge.api.request.WebloungeRequest, ch.o2it.weblounge.api.request.WebloungeResponse, java.lang.String, int)
	 */
	 ...
	 * @see ch.o2it.weblounge.Action.module.ActionHandler#init(ch.o2it.weblounge.api.module.ActionConfiguration)
	 */
	 ...
	 * the request.
	 * 
	 * @see ch.o2it.weblounge.Action.module.ActionHandler#cleanup()
	 */
	public void cleanup() {
		infoMessages = null;
