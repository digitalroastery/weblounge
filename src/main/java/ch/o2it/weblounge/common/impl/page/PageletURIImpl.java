...
public class PageletURIImpl implements PageletURI {
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.page.PageletURI#getSite()
   */
  public Site getSite() {
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.page.PageletURI#getPageURI()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.page.PageletURI#getComposer()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.page.PageletURI#getPosition()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.page.PageletURI#setURI(ch.o2it.weblounge.common.page.PageURI)
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.page.PageletURI#setComposer(java.lang.String)
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.page.PageletURI#setPosition(int)
   */
