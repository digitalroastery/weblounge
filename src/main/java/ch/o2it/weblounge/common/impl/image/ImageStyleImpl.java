...
public class ImageStyleImpl extends GeneralComposeable implements ImageStyle {
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.site.ImageStyle#setScalingMode(ch.o2it.weblounge.common.site.ScalingMode)
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.site.ImageStyle#getScalingMode()
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.site.ImageStyle#setHeight(int)
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.site.ImageStyle#setWidth(int)
   */
   ...
   * {@inheritDoc}
   * 
   * @see ch.o2it.weblounge.common.site.ImageStyle#getWidth()
   */
  public int getWidth() {
    return width;
  }
