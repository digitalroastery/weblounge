...
@XmlType(name = "ace", namespace = "ch.o2it.weblounge.security")
@XmlRootElement(name = "ace", namespace = "ch.o2it.weblounge.security")
public final class AccessControlEntryImpl implements AccessControlEntry {
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.security.AccessControlEntry#getRole()
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.security.AccessControlEntry#getAction()
   */
   ...
   * {@inheritDoc}
   *
   * @see ch.o2it.weblounge.common.security.AccessControlEntry#isAllowed()
   */
