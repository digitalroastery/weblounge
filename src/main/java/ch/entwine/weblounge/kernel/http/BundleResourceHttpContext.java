...
/**
 * This class is an <code>HttpContext</code> that is able to load resources from
...
public class BundleResourceHttpContext implements HttpContext {
  ...
  public boolean equals(Object o) {
    if (o instanceof BundleResourceHttpContext) {
      return ((BundleResourceHttpContext) o).getBundle().equals(bundle);
    }
    return false;
  }
