...
public class DefaultPageLayout extends LocalizableObject implements PageLayout {
   ...
   * @see ch.entwine.weblounge.common.content.page.PageLayout.content.Layout#getLanguage()
   */
   ...
   * @see ch.entwine.weblounge.common.content.page.PageLayout#isEditable(java.lang.String,
   ...
   *          the user
   * @see ch.entwine.weblounge.common.content.page.PageLayout#isEditable(java.lang.String,
   *      int, ch.entwine.weblounge.common.security.User)
   */
   ...
   *          the user
   * 
   * @see ch.entwine.weblounge.common.content.page.PageLayout#isMovable(java.lang.String,
   *      int, ch.entwine.weblounge.common.security.User)
   */
   ...
   * @param user
   *          the user
   * @see ch.entwine.weblounge.common.content.page.PageLayout#isRemovable(java.lang.String,
   *      int, ch.entwine.weblounge.common.security.User)
   */
