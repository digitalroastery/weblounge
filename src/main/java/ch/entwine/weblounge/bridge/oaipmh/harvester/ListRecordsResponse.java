...
/**
 * The "ListRecords" response. See <a href=
 * "http://www.openarchives.org/OAI/openarchivesprotocol.html#ListRecords">4.5
 * ListRecords</a> for further information.
 * <p/>
...
public class ListRecordsResponse extends OaiPmhResponse {
  ...
  /**
   * Extract the content, i.e. the first child node, of the metadata node of a
   * record.
   * 
   * <pre>
   *  &lt;record&gt;
  ...
  /**
   * Get all metadata performing a complete request resuming any partial
   * responses.
   */
  public static Iterable<Node> getAllMetadataElems(
      final ListRecordsResponse first, final OaiPmhRepositoryClient client) {
    return new Iterable<Node>() {
      public Iterator<Node> iterator() {
        return new ResponseIterator(first) {
          @Override
