 ...
 * <code>ElementIteratorTag</code> jsp tag.
 */
public class ElementIteratorTagExtraInfo extends TagExtraInfo {
  ...
  public VariableInfo[] getVariableInfo(TagData tagData) {
    return new VariableInfo[] {
        ...
        new VariableInfo(ElementIteratorTagVariables.ELEMENT_COUNT, Integer.class.getName(), true, VariableInfo.NESTED) };
  }
