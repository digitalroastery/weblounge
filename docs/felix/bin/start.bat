...
SET WEBLOUNGE_EXTDIR=%WEBLOUNGE_HOME%/ext
...
SET RUNTIME_OPTS=%WEBLOUNGE_HOME_OPTS% %WEBLOUNGE_SITES_OPTS% %WEBLOUNGE_SITES_DATA_OPTS% %WEBLOUNGE_LIB_OPTS% %WEBLOUNGE_EXT_OPTS% %TEMPDIR_OPTS% %GRAPHICS_OPTS% %WEBLOUNGE_FILEINSTALL_OPTS% %PAX_CONFMAN_OPTS% %WEBLOUNGE_LOGGING_OPTS% %PAX_LOGGING_OPTS%
