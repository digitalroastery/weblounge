 ...
 * availability of <code>XHTMLRenderer</code> binaries.
 */
public class XhtmlRendererActivator {

  /** The logger */
  private static final Logger logger = LoggerFactory.getLogger(XhtmlRendererActivator.class);

  /** The page preview generator */
  private XhtmlRendererPagePreviewGenerator previewGenerator = null;
  ...
  void activate(ComponentContext ctx) {
    ...
    logger.debug("Registering XHTMLRenderer page preview generator");
    previewGenerator = new XhtmlRendererPagePreviewGenerator();
