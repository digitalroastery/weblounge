...
public final class PersistenceUtil {
   ...
   * <code>emName</code>. A {@link PersistenceProvider} named
   * <code>persistence</code> has to be registered as an OSGi service. If you
   * want to configure the factory please also register a map containing all
   * properties under the name <code>persistenceProps</code>. See
   * {@link PersistenceProvider#createEntityManagerFactory(String, Map)} for
   * more information about config maps.
   */
  public static EntityManagerFactory newEntityManagerFactory(
      ComponentContext cc, String emName) {
   ...
   * local transactions.
   * <p/>
   * Please note that calling {@link PersistenceEnv#tx(Function)} always creates
   * a <em>new</em> transaction. Transaction propagation is <em>not</em>
   * supported.
   */
  public static PersistenceEnv newPersistenceEnvironment(
