...
@NamedQueries({
    @NamedQuery(name = "findLastHarvested", query = "SELECT a.timestamp FROM LastHarvested a WHERE a.url = :url"),
    @NamedQuery(name = "findAll", query = "SELECT a FROM LastHarvested a") })
public class LastHarvested {
  ...
  public static Option<Date> getLastHarvestDate(PersistenceEnv penv,
      final String url) {
