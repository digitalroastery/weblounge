...
public class PublishingContextImplXmlTest extends PublishingContextImplTest {
  ...
  /**
   * Test method for
   * {@link ch.entwine.weblounge.common.impl.content.PublishingContext#fromXml(org.w3c.dom.Node)}
   * .
   */
  @Test
  public void testFromXmlNode() {
    ...
    try {
      assertEquals(testXml, new String(ctx.toXml().getBytes("utf-8"), "utf-8"));
