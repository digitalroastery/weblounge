...
/**
 * An <code>JSONAction</code> is java code that can be mounted to a specific url
 ...
 * {@link ch.entwine.weblounge.common.request.RequestFlavor#JSON} request flavor</li>
 ...
 * <li>{@link #startJSON(WebloungeRequest, WebloungeResponse)}</li>
 * </ol>
 * <p>
 * <b>Note:</b> A class that implements the <code>JSONAction</code> interface
...
public interface JSONAction extends Action {
   ...
   * action to write the <code>JSON</code> data to the response.
   * <p>
   ...
   * <code>Content-Type", "text/json; charset=utf-8</code>, which means that you
   ...
   */
  void startJSON(WebloungeRequest request, WebloungeResponse response)
