 ...
 * movies that were found in the weblounge search index.
 * 
 * @see ch.entwine.weblounge.common.content.ResourceSearchResultItem
 */
public interface MovieSearchResultItem extends ResourceSearchResultItem {

  /**
   * Returns the audio visual resource.
   * 
   * @return the movie resource
   */
  MovieResource getMovieResource();
