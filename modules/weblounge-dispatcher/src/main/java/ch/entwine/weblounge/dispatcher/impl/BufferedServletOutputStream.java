...
/**
 * Extension to the <code>ServletOutputStream</code> which does not write the
 * content directly back to the client but buffers it locally in order to be
 * written back in one big chunk.
 */
