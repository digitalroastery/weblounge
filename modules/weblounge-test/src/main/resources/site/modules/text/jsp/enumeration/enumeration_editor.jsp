...
<h1><webl:i18n key="module.text.enumeration.enumeration"/></h1>
  <div id="mainTabContainerEnumeration">
    ...
    <table id="enumeration">
      <webl:content-iterator elements="text" minOccurs="1">
        <tr id="<%= index %>">
          <td class="dragHandle">&nbsp;</td>
          <%--TODO: delete-button doesn't work before the wizard was saved --%>
          <td><textarea name="element:text"></textarea> <img src="/weblounge-sites/<%= site.getIdentifier() %>/modules/text/jsp/enumeration/delete.png" alt="del" title="<%= site.getI18n().getAsHTML("module.text.enumeration.delete", language) %>" /></td>
        </tr>
